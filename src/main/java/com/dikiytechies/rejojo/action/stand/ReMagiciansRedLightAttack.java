...
public class ReMagiciansRedLightAttack extends StandEntityLightAttack {
    public ReMagiciansRedLightAttack(Builder builder) {
        super(builder);
    }
    ...
    protected ResourceLocation getIconTexturePath(@Nullable IStandPower power) {
        return JojoModUtil.makeTextureLocation("action", MAGICIANS_RED_PUNCH.get().getRegistryName().getNamespace(), this.getRegistryName().getPath());
    }
}
